...
namespace StardewEconMod
{
    ...
    {
        /// <summary>Warns user against editing the resulting json.</summary>
        public string wanring { get; } = "DO NOT EDIT THIS FILE OR IT WILL CAUSE THE ECONOMY MOD TO NOT WORK PROPERLY.";
